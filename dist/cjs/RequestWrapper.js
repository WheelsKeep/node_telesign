...
exports.RequestWrapper = exports.FetchRequestWrapper = void 0;
...
function __transformExtension(filepath, extMapping) {
  ...
  var _iterator = _createForOfIteratorHelper(Object.entries(extMapping).sort(function (a, b) {
  ...
  try {
    for (_iterator.s(); !(_step = _iterator.n()).done;) {
      var _step$value = _slicedToArray(_step.value, 2),
        origExt = _step$value[0],
        _newExt = _step$value[1];
...
var RequestWrapper = exports.RequestWrapper = /*#__PURE__*/function () {
  function RequestWrapper() {
    _classCallCheck(this, RequestWrapper);
  }
  return _createClass(RequestWrapper, [{
    key: "request",
...
var handleResponse = function handleResponse(response, callback) {
  var res = {
...
function _fetchWithTimeout() {
  _fetchWithTimeout = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(url, options) {
    var fetch;
...
var FetchRequestWrapper = exports.FetchRequestWrapper = /*#__PURE__*/function (_RequestWrapper) {
  function FetchRequestWrapper() {
    _classCallCheck(this, FetchRequestWrapper);
    return _callSuper(this, FetchRequestWrapper, arguments);
  }
  _inherits(FetchRequestWrapper, _RequestWrapper);
  return _createClass(FetchRequestWrapper, [{
    key: "request",
    value: function request(options, callback) {
